...
//        Uri defaultSoundUri= RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        ...
        builder.setContentTitle(notiTitle)   // 상태바 드래그시 보이는 타이틀
                ...
                .setSmallIcon(com.greencross.gctemperlib.R.drawable.hn_temper_icon)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), com.greencross.gctemperlib.R.drawable.hn_temper_icon))
