...
import com.greencross.gctemperlib.greencare.charting.animation.Easing;
import com.greencross.gctemperlib.greencare.charting.animation.EasingFunction;
import com.greencross.gctemperlib.greencare.charting.components.Description;
import com.greencross.gctemperlib.greencare.charting.components.IMarker;
...
import com.greencross.gctemperlib.greencare.charting.formatter.DefaultValueFormatter;
import com.greencross.gctemperlib.greencare.charting.formatter.IValueFormatter;
import com.greencross.gctemperlib.greencare.charting.highlight.ChartHighlighter;
import com.greencross.gctemperlib.greencare.charting.highlight.Highlight;
import com.greencross.gctemperlib.greencare.charting.highlight.IHighlighter;
import com.greencross.gctemperlib.greencare.charting.listener.ChartTouchListener;
import com.greencross.gctemperlib.greencare.charting.listener.OnChartGestureListener;
import com.greencross.gctemperlib.greencare.charting.listener.OnChartValueSelectedListener;
import com.greencross.gctemperlib.greencare.charting.renderer.DataRenderer;
import com.greencross.gctemperlib.greencare.charting.renderer.LegendRenderer;
import com.greencross.gctemperlib.greencare.charting.data.CEntry;
import com.greencross.gctemperlib.greencare.charting.data.ChartData;
import com.greencross.gctemperlib.greencare.charting.interfaces.dataprovider.ChartInterface;
import com.greencross.gctemperlib.greencare.charting.interfaces.datasets.IDataSet;
...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends CEntry>>> extends
    ...
    public ChartTimeUtil getTimeClass() {
        return mTimeClass;
    }

    public void setTimeClass(ChartTimeUtil timeClass) {
        this.mTimeClass = timeClass;
    }
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (e.getY() == 0) {
                Log.i(getClass().getSimpleName(), "XXXXXX position"+i+", e.getY()="+e.getY());
            } else {
                Paint paint = new Paint();
                paint.setColor(Color.parseColor("#ff0000"));
                paint.setStrokeWidth(2f);
                float markerHeight = 0f;
                if (mMarker instanceof MarkerView) {
                    MarkerView mv = (MarkerView)mMarker;
                    markerHeight = mv.getHeight();
                }
                Log.i(getClass().getSimpleName(), "markerHeight="+markerHeight);
                canvas.drawLine(pos[0], markerHeight , pos[0], pos[1], paint);
...
//            mMarker.draw(canvas, pos[0], pos[1]);
    ...
    public void setDrawMarkerViews(boolean enabled) {
        setDrawMarkers(enabled);        // 마커 표시 비활성/활성화 시키기
    }
