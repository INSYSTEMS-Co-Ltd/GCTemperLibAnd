...
import com.greencross.gctemperlib.greencare.charting.highlight.BarHighlighter;
import com.greencross.gctemperlib.greencare.charting.highlight.Highlight;
import com.greencross.gctemperlib.greencare.charting.renderer.StepBarChartRenderer;
...
import com.greencross.gctemperlib.greencare.charting.interfaces.dataprovider.BarDataProvider;
 ...
 */
public class FoodChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    public FoodChart(Context context) {
        super(context);
    }

    public FoodChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FoodChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new StepBarChartRenderer(this, mAnimator, mViewPortHandler);
