...
import com.greencross.gctemperlib.greencare.charting.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider;
import com.greencross.gctemperlib.greencare.charting.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import com.greencross.gctemperlib.greencare.charting.jobs.AnimatedMoveViewJob;
import com.greencross.gctemperlib.greencare.charting.jobs.AnimatedZoomJob;
import com.greencross.gctemperlib.greencare.charting.jobs.MoveViewJob;
import com.greencross.gctemperlib.greencare.charting.jobs.ZoomJob;
...
public class StickBarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
        ...
        extends SugarChart<T> implements BarLineScatterCandleBubbleDataProvider {
                ...
                if (mLegend.getHorizontalAlignment() == Legend.LegendHorizontalAlignment.CENTER) {
                    if (mLegend.getVerticalAlignment() == Legend.LegendVerticalAlignment.TOP) {
                        offsets.top += Math.min(mLegend.mNeededHeight,
                                ...
                                + mLegend.getYOffset();
                    } else if (mLegend.getVerticalAlignment() == Legend.LegendVerticalAlignment.BOTTOM) {
...
/** CODE BELOW IS GETTERS AND SETTERS */
     ...
     * @return
     */
    public MPPointF getPosition(CEntry e, YAxis.AxisDependency axis) {
