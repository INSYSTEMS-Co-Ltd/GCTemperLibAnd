 ...
 */
@SuppressLint("NewApi")
public abstract class SugarChart<T extends ChartData<? extends IDataSet<? extends CEntry>>> extends
        ViewGroup
     ...
     */
    public SugarChart(Context context) {
        super(context);
        init();
    }
     ...
     */
    public SugarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     */
    public SugarChart(Context context, AttributeSet attrs, int defStyle) {
