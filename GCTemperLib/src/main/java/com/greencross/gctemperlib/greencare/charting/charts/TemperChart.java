...
public class TemperChart extends BarLineChartBase<BarData> implements WeightBarDataProvider {
    ...
    private boolean mIsPregnantTab;
    ...
    public void setIsPregnantTab(boolean mIsPregnantTab) {
        this.mIsPregnantTab = mIsPregnantTab;
    }

    @Override
    public boolean isPregnantTab() {
        return mIsPregnantTab;
    }
