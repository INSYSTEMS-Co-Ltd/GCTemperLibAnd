...
public class StepBarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public StepBarChartRenderer(BarDataProvider chart, ChartAnimator animator,
    ...
    public void drawValues(Canvas c) {
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            for (int i = 0; i < mChart.getBarData().getDataSetCount(); i++) {
                ...
                // the value
                float valueTextHeight = Utils.calcTextHeight(mValuePaint, "30");
