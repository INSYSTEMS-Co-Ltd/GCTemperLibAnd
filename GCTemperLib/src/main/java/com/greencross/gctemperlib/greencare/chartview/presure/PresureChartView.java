...
package com.greencross.gctemperlib.greencare.chartview.presure;
...
import com.greencross.gctemperlib.greencare.charting.charts.PressureStickChart;
...
import com.greencross.gctemperlib.greencare.charting.data.PressureDataSet;
...
public class PresureChartView {
    ...
    public PresureChartView(Context context, View view) {
        mContext = context;
//        Typeface mTfRegular = ResourcesCompat.getFont(context, R.font.nanum_barun_gothic);
//        Typeface mTfLight = ResourcesCompat.getFont(context, R.font.nanum_barun_gothic_light);
