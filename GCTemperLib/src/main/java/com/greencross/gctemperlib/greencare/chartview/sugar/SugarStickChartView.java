...
package com.greencross.gctemperlib.greencare.chartview.sugar;
...
import com.greencross.gctemperlib.greencare.charting.charts.SugarStickChart;
...
import com.greencross.gctemperlib.greencare.charting.data.SticDataSet;
...
public class SugarStickChartView {
    ...
    private void setChartData(List<SticEntry> yVals1) {
        ...
        set1.setIncreasingColor(Color.rgb(245,89,0));
