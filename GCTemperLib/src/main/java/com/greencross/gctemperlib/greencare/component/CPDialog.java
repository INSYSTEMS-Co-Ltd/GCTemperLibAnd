...
public class CPDialog extends Dialog {
    ...
    public static CPDialog showDlg(Activity activity, String message, final DismissListener dismissListener) {
    ...
    public static CPDialog showDlg(Context context, String message, final DismissListener dismissListener) {
        final CPDialog dlg = getInstance(context);
        mDismissListener = dismissListener;
        dlg.setMessage(message);
        dlg.mOkButton.setVisibility(View.VISIBLE);
