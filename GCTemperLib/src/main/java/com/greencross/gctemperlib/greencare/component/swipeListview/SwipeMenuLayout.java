package com.greencross.gctemperlib.greencare.component.swipeListview;
...
//		}
	...
	private void setArrowImage(Boolean isOpen) {
		if (isOpen) {
			...
			mOpenIv.setImageResource(R.drawable.arrow_right);
		} else {
			mOpenIv.setImageResource(R.drawable.arrow_left);
		}
	}
