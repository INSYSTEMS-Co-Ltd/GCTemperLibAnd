    ...
    public void insert(SQLiteOpenHelper helper, Tr_get_hedctdata datas, boolean isServerReg) {
        ...
        try {
            for (Tr_get_hedctdata.DataList data : datas.data_list) {
                ...
                cv.put(PRESURE_IDX, data.idx);
                cv.put(PRESURE_ARTERIALPRESSURE, data.arterialPressure);
                cv.put(PRESURE_DIASTOLICPRESSUR, data.diastolicPressure);
                cv.put(PRESURE_PULSERATE, data.pulseRate);
                cv.put(PRESURE_SYSTOLICPRESSURE, data.systolicPressure);
                cv.put(PRESURE_DRUGNAME, data.drugname);
                cv.put(PRESURE_REGTYPE, data.regtype);
                cv.put(IS_SERVER_REGIST, isServerReg);
                cv.put(PRESURE_REGDATE, CDateUtil.getRegDateFormat_yyyyMMddHHss(data.reg_de));
                db.insert(TB_DATA_PRESSURE, null, cv);
...
//                mHelper.transactionExcute(sb.toString());
    ...
    */
    ...
    public List<PressureEntry> getResultDay(SQLiteOpenHelper helper, String nDate) {
        ...
        String sql = "Select "
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 0 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H0N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 0 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H0X, "
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 1 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H1N,"     //1시 MIN
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 1 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H1X,"     //1시 MAX
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 2 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H2N,"     //2시 MIN
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 2 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H2X,"     //2시 MAX
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 3 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H3N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 3 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H3X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 4 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H4N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 4 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H4X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 5 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H5N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 5 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H5X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 6 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H6N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 6 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H6X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 7 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H7N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 7 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H7X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 8 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H8N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 8 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H8X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 9 THEN "+PRESURE_DIASTOLICPRESSUR+"  End),0) as H9N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 9 THEN "+PRESURE_SYSTOLICPRESSURE+"  End),0) as H9X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 10 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H10N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 10 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H10X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 11 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H11N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 11 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H11X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 12 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H12N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 12 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H12X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 13 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H13N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 13 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H13X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 14 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H14N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 14 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H14X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 15 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H15N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 15 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H15X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 16 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H16N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 16 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H16X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 17 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H17N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 17 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H17X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 18 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H18N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 18 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H18X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 19 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H19N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 19 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H19X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 20 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H20N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 20 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H20X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 21 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H21N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 21 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H21X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 22 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H22N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 22 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H22X,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 23 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as H23N,"
                +" ifnull(AVG(CASE cast(strftime('%H', "+PRESURE_REGDATE+") as integer) WHEN 23 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as H23X  "
                +" FROM "+ TB_DATA_PRESSURE
    ...
    public List<PressureEntry> getResultWeek(SQLiteOpenHelper helper, String sDate, String eDate) {
        ...
        String sql = "Select "
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=0 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S1M,"    //수축기 MAX
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=0 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S1N,"    //수축기 MIN
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S2M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S2N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S3M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S3N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S4M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S4N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S5M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S5N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S6M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S6N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S7M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0) as S7N, "

                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=0 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D1M,"    //이완기 MAX
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=0 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D1N,"    //이완기 MIN
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D2M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D2N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D3M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D3N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D4M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D4N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D5M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D5N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D6M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D6N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D7M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%w', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0) as D7N"

                +" FROM " + TB_DATA_PRESSURE
                +" WHERE " + PRESURE_REGDATE +" BETWEEN '"+ sDate +" 00:00' and '"+eDate+" 23:59' and cast("+PRESURE_DIASTOLICPRESSUR+" as integer) > 0 and cast("+PRESURE_SYSTOLICPRESSURE+" as integer) > 0";
    ...
    public List<PressureEntry> getResultMonth(SQLiteOpenHelper helper, String nYear, String nMonth, int dayCnt) {
        ...
        List<PressureEntry> yVals1 = new ArrayList<>();
        String sql = "Select "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S1M,"  // 이완기 MIN
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S1N,"  // 이완기 MIN
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S2M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S2N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S3M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S3N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S4M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S4N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S5M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S5N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S6M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S6N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=7 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S7M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=7 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S7N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=8 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S8M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=8 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S8N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=9 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S9M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=9 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S9N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=10 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S10M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=10 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S10N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=11 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S11M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=11 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S11N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=12 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S12M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=12 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S12N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=13 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S13M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=13 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S13N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=14 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S14M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=14 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S14N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=15 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S15M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=15 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S15N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=16 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S16M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=16 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S16N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=17 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S17M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=17 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S17N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=18 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S18M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=18 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S18N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=19 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S19M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=19 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S19N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=20 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S20M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=20 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S20N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=21 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S21M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=21 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S21N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=22 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S22M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=22 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S22N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=23 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S23M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=23 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S23N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=24 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S24M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=24 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S24N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=25 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S25M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=25 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S25N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=26 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S26M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=26 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S26N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=27 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S27M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=27 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S27N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=28 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S28M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=28 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S28N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=29 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S29M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=29 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S29N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=30 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S30M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=30 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S30N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=31 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S31M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=31 THEN "+PRESURE_SYSTOLICPRESSURE+" End),0)as S31N, "

                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D1M,"  // 수축기 MAX
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=1 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D1N,"  // 수축기 MAX
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D2M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=2 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D2N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D3M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=3 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D3N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D4M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=4 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D4N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D5M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=5 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D5N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D6M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=6 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D6N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=7 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D7M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=7 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D7N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=8 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D8M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=8 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D8N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=9 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D9M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=9 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D9N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=10 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D10M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=10 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D10N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=11 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D11M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=11 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D11N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=12 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D12M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=12 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D12N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=13 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D13M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=13 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D13N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=14 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D14M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=14 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D14N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=15 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D15M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=15 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D15N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=16 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D16M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=16 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D16N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=17 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D17M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=17 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D17N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=18 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D18M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=18 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D18N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=19 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D19M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=19 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D19N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=20 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D20M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=20 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D20N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=21 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D21M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=21 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D21N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=22 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D22M,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=22 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D22N,"
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=23 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D23M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=23 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D23N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=24 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D24M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=24 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D24N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=25 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D25M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=25 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D25N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=26 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D26M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=26 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D26N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=27 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D27M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=27 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D27N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=28 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D28M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=28 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D28N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=29 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D29M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=29 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D29N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=30 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D30M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=30 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D30N, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=31 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D31M, "
                +" ifnull(AVG(CASE WHEN cast(strftime('%d', "+PRESURE_REGDATE+") as integer)=31 THEN "+PRESURE_DIASTOLICPRESSUR+" End),0)as D31N "
