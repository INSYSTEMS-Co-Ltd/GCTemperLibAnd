 ...
 *
 ...
 Input 값 api_code : api 코드명 insures_code : 회사코드(108) mber_sn : 기존회원키값 mber_hp : 핸드폰 번호
 Output 값 api_code : api 코드명 insures_code : 회원사 코드 reg_yn : 저장완료
 */

public class Tr_asstb_diet_program_req_crt extends BaseData {
	private final String TAG = Tr_asstb_diet_program_req_crt.class.getSimpleName();
	...
	public Tr_asstb_diet_program_req_crt() throws JSONException {
	...
	public JSONObject makeJson(Object obj) throws JSONException {
		if (obj instanceof RequestData) {
			...
			body.put("api_code", "asstb_diet_program_req_crt");
