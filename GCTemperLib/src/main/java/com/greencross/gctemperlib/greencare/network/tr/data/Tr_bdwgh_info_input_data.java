...
public class Tr_bdwgh_info_input_data extends BaseData {
    ...
    public String reg_yn; //
     ...
     @SerializedName("now_weight") // 88.1",
     public String now_weight;
     @SerializedName("kg_kind") // 고도비만군",
     public String kg_kind;
     @SerializedName("mber_bdwgh_goal") // 50",
     public String mber_bdwgh_goal;
     @SerializedName("birth_chl_yn") // Y",
     public String birth_chl_yn;
     @SerializedName("mber_birth_due_de") // 20180511",
     public String mber_birth_due_de;
     @SerializedName("mber_chl_birth_de") // 20180511",
     public String mber_chl_birth_de;
     @SerializedName("mber_kg") // 88.1",
     public String mber_kg;
     @SerializedName("mber_term_kg") // 80",
     public String mber_term_kg;
     @SerializedName("dta") // 1",
     public String dta;
     @SerializedName("input_de") // 20170607",
