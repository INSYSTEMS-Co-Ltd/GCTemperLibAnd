...
public class Tr_content_special_bbslist_food extends BaseData {
    private final String TAG = Tr_content_special_bbslist_food.class.getSimpleName();
    ...
    public Tr_content_special_bbslist_food() {
    ...
    public JSONObject makeJson(Object obj) throws JSONException {
        ...
        if (obj instanceof Tr_content_special_bbslist_food.RequestData) {
            JSONObject body = new JSONObject();
            Tr_content_special_bbslist_food.RequestData data = (Tr_content_special_bbslist_food.RequestData) obj;

            body.put("api_code", getApiCode("Tr_content_special_bbslist_food") );
