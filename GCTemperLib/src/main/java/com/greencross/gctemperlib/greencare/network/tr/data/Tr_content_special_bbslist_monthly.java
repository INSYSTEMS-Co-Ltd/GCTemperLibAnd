...
/**
 *
 건강정보 monthly health  11대 질병정보
 */

public class Tr_content_special_bbslist_monthly extends BaseData {
    private final String TAG = Tr_content_special_bbslist_monthly.class.getSimpleName();
    ...
    public Tr_content_special_bbslist_monthly() {
    ...
    public JSONObject makeJson(Object obj) throws JSONException {
        ...
        if (obj instanceof Tr_content_special_bbslist_monthly.RequestData) {
            JSONObject body = new JSONObject();
            Tr_content_special_bbslist_monthly.RequestData data = (Tr_content_special_bbslist_monthly.RequestData) obj;

            body.put("api_code", getApiCode("Tr_content_special_bbslist_monthly") );
