...
public class Tr_mvm_goalqy extends BaseData {
    ...
    public JSONObject makeJson(Object obj) throws JSONException {
        ...
        if (obj instanceof Tr_mvm_goalqy.RequestData) {
            ...
            body.put("api_code", getApiCode("Tr_mvm_goalqy"));
            ...
            body.put("goal_bdwgh", data.goal_bdwgh);
            return body;
        }
    ...
    @SerializedName("goal_bdwgh")
    public String goal_bdwgh;
