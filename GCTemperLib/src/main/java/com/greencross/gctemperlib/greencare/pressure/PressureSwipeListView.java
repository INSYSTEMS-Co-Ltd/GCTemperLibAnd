...
import com.greencross.gctemperlib.greencare.component.UpdateDialog;
...
import com.greencross.gctemperlib.greencare.network.tr.data.Tr_brssr_info_del_data;
...
public class PressureSwipeListView {
    ...
    class showModifiDlg {
        ...
        private showModifiDlg(final Tr_get_hedctdata.DataList data) {
            ...
            final UpdateDialog dlg = UpdateDialog.showDlg(mBaseFragment.getContext(), modifyView);
            if (mIsMedicenMode)
            ...
            mSaveBtn = (ImageButton) modifyView.findViewById(R.id.pressure_input_save_btn);
