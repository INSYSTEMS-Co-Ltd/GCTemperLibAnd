...
import com.greencross.gctemperlib.greencare.network.tr.data.Tr_bdsg_info_del_data;
import com.greencross.gctemperlib.greencare.network.tr.data.Tr_bdsg_info_edit_data;
...
public class SugarSwipeListView {
    ...
    class AppAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (StringUtil.getFloat(data.sugar) <= 0f) {
                ...
                holder.sugarTv.setText((int)StringUtil.getFloat(data.sugar)+"");
    ...
    class showModifiDlg {
        ...
        private showModifiDlg(final Tr_get_hedctdata.DataList data) {
            ...
            mSaveBtn = (ImageButton) modifyView.findViewById(R.id.sugar_input_save_btn);
