...
//                menu.addMenuItem(item1);
    ...
    class AppAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.weightTv.setText(data.weight);//StringUtil.getNoneZeroString(StringUtil.getFloatVal(data.weight)));
...
//            mWeightTargetInputEt.setHint(login.mber_bdwgh_goal);  XXX
