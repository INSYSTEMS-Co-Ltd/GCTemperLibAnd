...
import com.greencross.gctemperlib.hana.chart.value.TypeDataSet;
...
public class ChartTimeUtil implements Cloneable {
...
//            }
        } else if (periodType == TypeDataSet.Period.PERIOD_YEAR) {
