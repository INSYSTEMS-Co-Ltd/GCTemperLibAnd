...
public class StringUtil {
     ...
     * @return date 가 "-", "." 중 어떤 것을 포함하고 있어도 "-" 로 변환
     */
    public static String getConvertedDateFormatYY_MM_DD(String date) {
    ...
    //ssshin add 2018.10.30 소수점을 처음 입력시 문제발생 수정
...
//		if ("0".equals(str.toString()))
    ...
    public static String getIntStringMinus(String str) {
//		if ("0".equals(str.toString()))
        if (str == null) str = "";
        str = str.replaceAll("[^0-9 \\-]", "");
...
//		if ("0".equals(str.toString()))
     ...
     * @return String
     */
    public static int getIntValMinus(String str) {
        if (str == null || TextUtils.isEmpty(str)) str = "0";
        str = getIntStringMinus(str);
        if ("-".equals(str))
            str = "0";
    ...
    public static float getFloatVal(String str) {
        str = TextUtils.isEmpty(str) ? "0" : getFloatString(str);
     ...
     * @return
     */
        public static boolean isValidId(String target) {
...
//        String pattern = "^[a-zA-Z가-힣]*$";
    ...
    public static boolean isSpecialWordNum(String target) {
        String pattern = "^[a-zA-Z가-힣]*$";
//        String pattern = "^[a-zA-Z가-힣0-9]*$";
        return Pattern.matches(pattern, target);
    }
     ...
     * @return String
     */
    public static String getFormatPriceFloat(String str) {
        try {
            str = getFloatString(str);
            if (TextUtils.isEmpty(str)) {
                str = "0";
            ...
            Log.i(TAG, "str="+str+", rem="+Arrays.toString(strArr));
            if (getIntVal(strArr[1]) == 0)
                return getFormatPrice(strArr[0]);

            return makeMoneyType(getDouble(str));
        } catch (Exception e) {
            e.printStackTrace();
            return "0";
        }
     ...
     * </pre>
     *
     * @param    dblMoneyString 금액 (double형).
     * @return   변경된 금액 문자열.
     */
